...
from app.models.enums import UserRole, ConsultationStatus, OrderStatus
...
def test_reviews_system_lifecycle(db_session):
    ...
    db_session.execute(DoctorReview.__table__.delete())
    db_session.execute(ProductReview.__table__.delete())
    db_session.execute(Consultation.__table__.delete())
    db_session.execute(OrderItem.__table__.delete())
    db_session.execute(Order.__table__.delete())
    db_session.execute(Pet.__table__.delete())
    db_session.execute(Doctor.__table__.delete())
    db_session.execute(Clinic.__table__.delete())
    
    # Clean up test users
    for email in [cust_email, doc_email]:
