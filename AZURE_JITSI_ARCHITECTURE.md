# 🏥 Scooby's Kitchen: Azure Self-Hosted Jitsi Telemedicine Architecture & Feature Specification

## 1. Purpose

This document defines the **architecture, technical design, and build specification** for the **Real-Time Video Telemedicine Consultation System** in Scooby's Kitchen powered by a **Self-Hosted Jitsi Meet cluster on Microsoft Azure**.
...
The system preserves our layered separation:
...
![Azure Self-Hosted Jitsi Telemedicine System Architecture](./docs/jitsi_azure_architecture.jpg)
